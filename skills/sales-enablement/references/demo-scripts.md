...
Scene-by-scene templates for different call types, with timing, talk tracks, and interaction 指导.

## Discovery Call Script

**Duration:** 30 minutes
**Goal:** Qualify the opportunity, understand pain, map the buying 流程.
...
**Questions to ask:**
- "Can you walk me through how your team handles [relevant 流程] today?"
- "What tools are you currently using for this?"
- "How many people are involved in this 工作流?"
- "How long has this been in place?"

**What you're listening for:**
- Current 流程 and tools
...
**Questions to ask:**
- "What's the biggest challenge with that 流程 today?"
...
- "Who else is affected by this 问题?"
- "Is there 预算 allocated for solving this?"

**What you're listening for:**
- Priority level (nice-to-have vs. must-solve)
- Urgency and consequences of inaction
- Organizational breadth of the 问题
- 预算 signals

---

### Scene 5: Buying 流程 (3 min)

**Questions to ask:**
- "If you decided this was the right solution, what does the evaluation 流程 look like?"
- "Who else would be involved in the decision?"
- "Have you evaluated solutions for this before?"
- "What's your timeline for making a decision?"

**What you're listening for:**
- Decision-making 流程 and stakeholders
...
**Talk track:**
> "Based on what you've shared, I think there's a strong fit — specifically around [pain point 1] and [pain point 2]. What I'd suggest as a next step is a 30-minute demo where I can show you exactly how we'd address those. I'll customize it to your 工作流. Does [specific date/time] work?"
...
**Goal:** Show how your 产品 solves their specific pain. Advance to evaluation/pilot.
...
### Scene 2: 工作流 1 — Primary Pain Point (10 min)

**Structure:**
1. Restate the pain: "You mentioned [specific 问题]..."
2. Show the solution: Walk through the 工作流 step by step
3. Highlight the outcome: "This means [specific 收益]..."
...
### Scene 3: 工作流 2 — Secondary Pain Point (8 min)

**Structure:**
Same as 工作流 1 — restate pain, show solution, highlight outcome.
...
### Scene 4: 工作流 3 — Differentiator (7 min)

**Structure:**
Show something they can't do today and can't get from competitors.

**Talk track:**
> "This is where we're really different from [competitor/status quo]. [Explain the unique capability]. For 示例, [客户] uses this to [specific outcome]."
...
**Talk track:**
> "Let me share a quick 示例. [客户 similar to them] was in a similar situation — [brief challenge]. After implementing, they saw [specific 指标]. Their [role] said [quote]."
...
**Talk track:**
> "Based on what we've covered, here's what I'd recommend as next 步骤: [specific next step]. This typically takes [timeline]. Who else on your team should be involved? I can set up a [follow-up meeting 类型] for [date]."
...
### Scene 2: Architecture 概览 (10 min)
...
### Scene 3: Security & 遵循率 (10 min)

**Cover:**
- Certifications (SOC 2, ISO 27001, HIPAA, etc.)
- Data encryption (at rest, in transit)
- Access controls and 认证 (SSO, RBAC)
- Audit logging
- Data residency and 隐私 (GDPR, CCPA)
- Penetration 测试 cadence
...
**Goal:** Get executive buy-in on the business case. Advance to 预算 approval or decision.

### Scene 1: Opening (2 min)

**Talk track:**
> "Thanks for your time, [Name]. [Champion] has been evaluating [your 产品] and the results look strong. I'll keep this focused on the business impact and what a partnership looks like. I know your time is valuable so I'll aim to leave 10 minutes for questions."

**What to do:**
- Be concise — executives punish rambling
- 参考 the champion and work done so far
- Set a clear agenda

---

### Scene 2: The 问题 & Cost (5 min)

**Talk track:**
> "Based on what [Champion] shared, your team is spending [X hours/$ amount] on [问题]. That's [annual cost]. It's also creating [secondary impact: risk, delays, churn]. This isn't unique to you — it's an industry-wide challenge, and the companies solving it are seeing [outcome]."

**What to do:**
- Use their numbers, not generic benchmarks
- Connect to 指标 they care about (revenue, cost, risk)
...
**Talk track:**
> "Here's what we do differently. [One-sentence explanation]. For your team specifically, this means [specific 收益 1] and [specific 收益 2]. [Champion]'s team has already seen [early result or reaction from evaluation]."

**What to do:**
- High-level, not feature-level
- Tie to their strategic priorities
- 参考 the champion's evaluation
...
**Talk track:**
> "Here's the business case. Based on your team's numbers: [walk through ROI calculation]. Expected payback period is [X months]. Over 3 years, the total value is [$ amount]. [客户 similar to them] saw [specific result] within [timeframe]."
...
**Talk track:**
> "What questions do you have? And — assuming the business case holds up, what does the decision 流程 look like from here?"
...
## Interaction Point 指导

### When to Ask Questions During Demos

- **After showing each 工作流** — "How does this compare to your current 流程?"
...
3. **If it's not possible** — "We don't do that today. Here's how 客户 handle it: [alternative]."
