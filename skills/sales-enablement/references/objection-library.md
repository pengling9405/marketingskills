...
常见 B2B SaaS 异议 with response frameworks. Organized by category for quick 参考.

## Quick-参考 Table

For live calls. Find the objection, scan the response, 参考 the proof.

| Objection | Response (1-line) | Proof Point |
|-----------|--------------------|-------------|
| "Too expensive" | "Compared to what? Let's look at what the 问题 costs you today." | ROI case study showing payback in X months |
| "No 预算" | "When 预算 opens up, what would need to be true for this to be a priority?" | 客户 who started with a pilot to prove value |
| "Competitor is cheaper" | "They are — here's what you give up at that price point." | Feature comparison + 客户 who switched |
| "Not the right time" | "What changes next quarter that makes it better timing?" | Cost-of-delay calculation |
| "Maybe next quarter" | "Happy to reconnect. What would a pilot look like before then?" | 客户 who started small and expanded |
| "We use X already" | "How's that working for [specific pain area]?" | 客户 who switched from X |
...
| "Not broken, don't fix it" | "Agreed — this isn't about fixing, it's about the opportunity cost of the current approach." | 客户 who didn't know what they were missing |
| "Does it integrate with X?" | "Yes / Let me check and get you specifics by end of day." | Integration documentation, 客户 using same stack |
| "Security concerns" | "Completely fair. Here's our security 概览 — happy to loop in our team." | SOC 2 report, security whitepaper |
| "Can it scale?" | "We serve companies from [small] to [large]. Here's an 示例 at your scale." | Case study at similar scale |
| "We tried something like this before" | "What went wrong? Understanding that helps me show how we're different." | 客户 with same failed experience who succeeded with you |
...
**Why they say it:** May be genuine 预算 constraint, sticker shock, or negotiation tactic. Often means they don't yet see enough value to justify the cost.

**Response approach:**
1. Don't defend the price immediately. Ask "Compared to what?"
2. Reframe from cost to investment — what does the 问题 cost them today?
3. Walk through the ROI calculation together
4. If 预算 is real, explore smaller starting points

**Talk track:**
> "I hear that. Let me ask — what's the cost of the 问题 we discussed? You mentioned your team spends [X hours] on [task] every week. At your team's loaded cost, that's roughly [$ amount] per year. Our solution runs [$ price] — so the question is whether eliminating that 问题 is worth the investment."
...
#### "We don't have 预算 for this"

**Why they say it:** 预算 may genuinely be allocated. Or they haven't identified 预算 because priority isn't established.

**Response approach:**
1. Validate — 预算 constraints are real
2. Understand timing — when does 预算 cycle reset?
3. Explore alternatives — pilot, smaller scope, different 预算 line
4. Help them build the business case to create 预算

**Talk track:**
> "Totally understand. Two questions: When does your next 预算 cycle open? And — if we could show clear ROI with a limited pilot, is that something you could fund from a different line item? Sometimes teams fund this from the efficiency savings it creates."

**Proof point:** 客户 who started with a small pilot and expanded after proving ROI.
...
**Why they say it:** They're comparing prices, possibly without comparing 能力. May be using competitor price as leverage.
...
4. Share proof from 客户 who evaluated both

**Talk track:**
> "You're right, [Competitor] is less expensive. Here's what I've seen from teams who evaluated both: [Competitor] works well for [their strength]. Where it falls short is [specific gap]. 客户 like [name] actually switched to us after starting with [Competitor] because [specific reason]. The question is whether [specific capability] is worth the difference for your team."

**Proof point:** 客户 who switched from the competitor, with specific reasons.
...
3. Explore low-承诺 next 步骤 that keep momentum
4. Set a concrete follow-up date

**Talk track:**
> "I get it — timing matters. Can I ask what's taking priority right now? The reason I bring up timing is that every month of [问题], based on our earlier conversation, costs your team roughly [$ amount]. A 3-month delay is [$ amount]. What if we mapped out a start date that works with your calendar so you're not losing that value?"
...
**Proof point:** 客户 who started the evaluation 流程 early and was live by their target date.
...
**Response approach:**
1. Don't list 特性 — give the one thing that matters most for their situation
2. Tie the differentiator to their specific pain
3. Back it up with proof
4. Offer to show, not just tell

**Talk track:**
> "For teams like yours — [their industry/size/use case] — the biggest difference is [specific differentiator]. That matters because [connection to their pain]. For 示例, [客户] was evaluating us alongside [Competitor] and chose us because [specific reason]. Want me to walk you through how that works?"

**Proof point:** Case study of a 客户 who chose you over alternatives.
...
**Why they say it:** Enterprise buying involves multiple stakeholders. Genuine 流程, not a brush-off.
...
4. Help your champion navigate the internal 流程
...
**Talk track:**
> "It probably does work — and I wouldn't suggest changing something that's truly meeting your needs. The question I'd ask is: is 'works fine' the bar? Teams using [your 产品] are seeing [specific outcome]. If you're leaving [X% improvement] on the table, is that worth exploring?"
...
**Why they say it:** Integration is a real requirement. They need to know your 产品 fits their stack.
...
**Talk track (if yes):**
> "Yes, we integrate with [X] natively. It takes about [time] to set up. [客户] runs the same stack and here's how they have it configured."

**Talk track (if no):**
> "We don't have a native integration with [X] today. Here's what 客户 typically do: [alternative]. We also have an open API that [description]. Would it help to get our technical team on a call to explore options?"

**Proof point:** 客户 using the same tech stack, integration documentation.
...
**Talk track:**
> "That's exactly the right question to ask. Here's our security 概览 — we're [SOC 2 类型 II / ISO 27001 / etc.] certified, and I can share our full security documentation. We also have a security team that's happy to do a review call with your infosec team. What are your specific requirements?"

**Proof point:** Security certifications, 遵循率 documentation, 客户 in regulated industries.
