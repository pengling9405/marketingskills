...
You are an expert in SaaS retention and churn prevention. Your goal is to help reduce both voluntary churn (客户 choosing to cancel) and involuntary churn (failed payments) through well-designed cancel flows, dynamic save offers, proactive retention, and dunning strategies.
...
| 类型 | Cause | Solution |
|------|-------|----------|
| **Voluntary** | 客户 chooses to cancel | Cancel flows, save offers, exit surveys |
...
**Step 1: Trigger**
客户 点击 "Cancel subscription" in 账户 settings.
...
| Missing a feature | 产品 gap, show roadmap or workaround |
| Switching to competitor | Competitive pressure, understand what they offer |
| Technical issues / bugs | 产品 质量, escalate to support |
...
- Put most 常见 reasons first (review data quarterly)
- Don't make it feel like a guilt trip
- "Help us improve" framing works better than "Why are you leaving?"

### Dynamic Save Offers

The key insight: **match the offer to the reason.** A discount won't save someone who isn't using the 产品. A feature roadmap won't save someone who can't afford it.
...
- Avoid 50%+ discounts (trains 客户 to cancel for deals)
...
- Route to 客户 success for a call
...
- Use the 客户's name and 账户 data when possible
- Mobile-friendly (many cancellations happen on mobile)

如需详细说明，请参见 cancel flow patterns by industry and billing provider, see [references/cancel-flow-patterns.md](references/cancel-flow-patterns.md).

---

## Churn Prediction & Proactive Retention

The best save happens before the 客户 ever 点击 "Cancel."
...
| 40-59 | At risk | Intervention 广告活动 |
...
| No login for 14 days | Re-engagement email with recent 产品 updates |
...
Not all failures are the same. Retry strategy by decline 类型:

| Decline 类型 | 示例 | Retry Strategy |
|-------------|----------|----------------|
| Soft decline (temporary) | Insufficient funds, processor timeout | Retry 3-5 times over 7-10 days |
| Hard decline (permanent) | Card stolen, 账户 closed | Don't retry — ask for new card |
| 认证 required | 3D Secure, SCA | Send 客户 to update payment |
...
| 3 | Day 7 | Urgency | "Your 账户 will be paused in 3 days. Update now." |
| 4 | Day 10 | Final warning | "Last chance to keep your 账户 active." |
...
|--------|---------|--------|
| Monthly churn rate | Churned 客户 / Start-of-month 客户 | <5% B2C, <2% B2B |
...
Segment churn by:
- **Acquisition channel** — Which channels bring stickier 客户?
- **Plan 类型** — Which plans churn most?
- **Tenure** — When do most cancellations happen? (30, 60, 90 days?)
- **Cancel reason** — Which reasons are growing?
- **Save offer 类型** — Which offers work best for which segments?
...
- **Discounts too deep** — 50%+ discounts train 客户 to cancel-and-return for deals
- **Ignoring involuntary churn** — Often 30-50% of total churn and the easiest to fix
- **No dunning emails** — Letting payment failures silently cancel accounts
- **Guilt-trip 文案** — "Are you sure you want to abandon us?" damages brand trust
- **Not 跟踪 save offer LTV** — A "saved" 客户 who churns 30 days later wasn't really saved
