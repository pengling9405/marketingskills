...
| optimizely | A/B 测试 | ✓ | - | [✓](clis/optimizely.js) | ✓ | [optimizely.md](integrations/optimizely.md) |
...
| pendo | 产品 分析 | ✓ | - | [✓](clis/pendo.js) | - | [pendo.md](integrations/pendo.md) |
...
| wistia | 视频 | ✓ | - | [✓](clis/wistia.js) | - | [wistia.md](integrations/wistia.md) |
...
Track user behavior, measure 转化, and analyze 营销 表现.

| Tool | Best For | MCP 可用 |
|------|----------|:-------------:|
| **ga4** | Web 分析, Google ecosystem | ✓ |
| **mixpanel** | 产品 分析, 事件 跟踪 | - |
| **amplitude** | 产品 分析, cohort analysis | - |
| **posthog** | 开源 分析, 会话回放 | - |
| **segment** | 客户 data 平台, routing | - |
| **adobe-分析** | Enterprise 分析 | - |
| **plausible** | 隐私-focused 分析 | - |

**Agent recommendation**: Start with GA4 if using Google ecosystem. Use Mixpanel or Amplitude for deeper 产品 分析. Plausible for 隐私-focused sites.

### SEO

搜索 engine optimization tools for 关键词 research, rank 跟踪, and site audits.

| Tool | Best For | 说明 |
|------|----------|-------|
| **google-搜索-console** | Free, authoritative 搜索 data | Direct from Google |
| **semrush** | Competitive analysis, 关键词 research | Comprehensive |
| **ahrefs** | Backlink analysis, content research | Best for links |
| **dataforseo** | SERP 跟踪, backlinks, on-page audits | Comprehensive API |
| **关键词-everywhere** | Quick 关键词 research, traffic estimates | Credit-based |

**Agent recommendation**: Google 搜索 Console is essential (free). Add Semrush or Ahrefs for competitive research. DataForSEO for programmatic SERP data. 关键词 Everywhere for quick 关键词 lookups.

### CRM

客户 relationship management and sales tools.

| Tool | Best For | CLI 可用 |
|------|----------|:-------------:|
| **hubspot** | SMB, 营销 + sales alignment | ✓ |
...
**Agent recommendation**: Stripe is the default for SaaS. Paddle for built-in tax 遵循率.

### Referral & Affiliate

Tools for referral programs, affiliate 跟踪, and partner management.
...
| Tool | Best For | MCP 可用 |
|------|----------|:-------------:|
| **mailchimp** | SMB email 营销 | ✓ |
| **客户-io** | Behavior-based messaging | - |
...
**Agent recommendation**: Resend for transactional (dev-friendly). Postmark for deliverability. 客户.io for advanced automation. Kit for creators. Beehiiv for newsletters. Klaviyo for e-commerce email/SMS. ActiveCampaign for email + CRM combo.

### Advertising

Paid advertising platforms and 广告活动 management.

| Tool | Best For | MCP 可用 |
|------|----------|:-------------:|
| **google-ads** | 搜索 intent, high-intent traffic | ✓ |
| **meta-ads** | Demand gen, visual products, B2C | - |
| **linkedin-ads** | B2B, job title targeting | - |
| **tiktok-ads** | Younger demographics, 视频 | - |

**Agent recommendation**: Google Ads for 搜索 intent. Meta for demand generation. LinkedIn for B2B.

### Automation

工作流 automation and integration platforms.
...
转化率 optimization, heatmaps, and experimentation.

| Tool | Best For | 说明 |
|------|----------|-------|
| **hotjar** | Heatmaps, recordings, surveys | Visual behavior data |
| **optimizely** | A/B 测试, 功能开关 | Enterprise experimentation |
...
In-app messaging, chat, and 客户 communication.

| Tool | Best For | 说明 |
|------|----------|-------|
| **intercom** | In-app messaging, support, 产品 tours | Full 客户 平台 |

**Agent recommendation**: Intercom for in-app messaging and 客户 support.

### Social Media

Social media scheduling, management, and 分析.

| Tool | Best For | 说明 |
|------|----------|-------|
| **buffer** | Social scheduling, 分析 | Multi-平台 |

**Agent recommendation**: Buffer for scheduling and 分析 across social platforms.

### 视频

视频 hosting, 分析, and engagement.

| Tool | Best For | 说明 |
|------|----------|-------|
| **wistia** | 视频 hosting, 营销 分析 | Best for 营销 视频 |

**Agent recommendation**: Wistia for 营销 视频 hosting with 分析.

### Data Enrichment

Company and person data enrichment for sales and 营销.
...
Review management and 社会认同 platforms.
...
Webinar and virtual 事件 platforms.

| Tool | Best For | 说明 |
|------|----------|-------|
| **demio** | 营销 webinars | Simple, focused |
| **livestorm** | 视频 engagement, webinars | Full 事件 平台 |

**Agent recommendation**: Demio for 营销-focused webinars. Livestorm for full 事件 engagement.
...
| Tool | Best For | 说明 |
|------|----------|-------|
| **outreach** | Enterprise sales engagement | Sequences, tasks, 分析 |

**Agent recommendation**: Outreach for enterprise sales teams managing multi-touch sequences at scale.

### 产品 分析

产品 分析, feature adoption 跟踪, and in-app 指导.

| Tool | Best For | 说明 |
|------|----------|-------|
| **pendo** | Feature adoption, in-app guides | 产品-led growth |

**Agent recommendation**: Pendo for 跟踪 feature adoption and delivering targeted in-app 指导.

### Competitive Intelligence

Traffic 分析, competitor benchmarking, and market research.

| Tool | Best For | 说明 |
|------|----------|-------|
| **similarweb** | Website traffic, competitor analysis | Traffic sources, 关键词 |
...
| Tool | Best For | 说明 |
|------|----------|-------|
| **airops** | AI content 工作流, SEO content | Flow-based automation |

**Agent recommendation**: AirOps for building AI content 工作流 that generate SEO-optimized content at scale.
...
| Tool | Best For | 说明 |
|------|----------|-------|
| **crossbeam** | 账户 overlaps, co-sell | Now part of Reveal |
...
| Tool | Best For | 说明 |
|------|----------|-------|
| **hunter** | Email finding, domain 搜索 | Largest email database |
| **snov** | Email finding, drip 广告活动 | Built-in sequences |
| **lemlist** | Cold email 广告活动 | Personalization 特性 |
| **instantly** | Cold email at scale | Email warmup built-in |

**Agent recommendation**: Hunter for finding emails. Lemlist or Instantly for sending cold email 广告活动. Snov for combined finding + outreach.

### Data Aggregation

营销 data pipeline tools that connect multiple platforms for unified reporting.

| Tool | Best For | 说明 |
|------|----------|-------|
| **supermetrics** | Cross-平台 data pulling | 200+ connectors |
| **coupler** | Automated data flows to sheets/BI | Scheduled pipelines |

**Agent recommendation**: Supermetrics for pulling data from multiple 营销 platforms into unified reports. Coupler.io for automated data flows to spreadsheets and BI tools.
...
| Tool | Best For | CLI 可用 |
|------|----------|:-------------:|
| **shopify** | E-commerce, 产品 sales | ✓ |
| **wordpress** | Blogs, content sites | ✓ |
| **webflow** | Design-focused 营销 sites | ✓ |
| **sanity** | Headless CMS, structured content | ✓ |
| **contentful** | Enterprise headless CMS, multi-locale | ✓ |
| **strapi** | 开源 headless CMS, self-hosted | ✓ |

**Agent recommendation**: Shopify for e-commerce. Webflow for 营销 sites. WordPress for blogs. For headless CMS: Sanity for developer-flexible content, Contentful for enterprise multi-locale, Strapi for self-hosted/预算-conscious. See [headless CMS guide](../skills/content-strategy/references/headless-cms.md) for selection criteria.

---

## CLI Tools

Zero-dependency, single-file Node.js CLIs for tools that don't ship their own. See [@@INLINE1@@](clis/README.md) for install instructions and usage.
...
- **ga4** - Google 分析 4 data access
- **stripe** - Payment and subscription 管理
- **mailchimp** - Email 广告活动 管理
- **google-ads** - Ad 广告活动 管理
- **resend** - Transactional email sending
- **zapier** - 工作流 automation
- **zoominfo** - B2B contacts and intent data
- **clay** - Data enrichment and outbound automation
- **supermetrics** - Cross-平台 营销 data
- **coupler** - 营销 data pipelines
- **outreach** - Sales engagement sequences
- **crossbeam** - Partner ecosystem data
- **introw** - Partner relationship 管理
...
### Setting up 分析 跟踪
1. Read [ga4.md](integrations/ga4.md) for web 分析
...
### Running paid ads
1. Read [google-ads.md](integrations/google-ads.md) for 搜索 广告活动
2. Read [meta-ads.md](integrations/meta-ads.md) for social 广告活动
